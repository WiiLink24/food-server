...
def upgrade():
    ...
    op.alter_column('shops', 'category_code',
               existing_type=postgresql.ENUM('Pizza', 'Bento_Box', 'Sushi', 'Fish', 'Seafood', 'Western', 'Fast_Food', 'Curry', 'Party_Food', 'Drinks', 'Others', name='categorytypes'),
               nullable=False)
    op.alter_column('user_orders', 'basket',
...
def downgrade():
    ...
    sa.Column('basket', sa.TEXT(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('zip_code', name='orders_pkey')
    )
    # ### end Alembic commands ###
